...
CUSTOMERS = {
    "craig": [
        {
            "display_name": "Riverside Apartments",
        ...
        {
            "display_name": "Oak Street HOA",
            "email": "board@oakstreethoa.com",
    ...
    "maya": [
        {
            "display_name": "Craig's Landscaping",
            "email": "craig@craigslandscaping.com",
            "payment_terms": "net_30",
            "discount_percent": "2",
            "discount_days": 10,
            "net_days": 30,
